    ...
    <div style={{ background: "#0a0a0a", minHeight: "100vh", color: "#f0f0f0" }}>
      ...
      <section id="meta" className="cs-meta-section" style={{ padding: "72px 24px", borderBottom: `1px solid rgba(255,255,255,0.06)` }}>
        <div className="cs-meta-grid" style={{ maxWidth: "1000px", margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(200px,1fr))", gap: "1px", background: "rgba(255,255,255,0.06)", borderRadius: "4px", overflow: "hidden" }}>
          {[
            ...
            <div key={item.label} className="cs-meta-cell" style={{ padding: "32px 28px", background: "#0f0f0f" }}>
              <div style={{ fontFamily: '"Press Start 2P",monospace', fontSize: "clamp(6px,1.2vw,7px)", color: "rgba(255,215,0,0.5)", letterSpacing: "2px", marginBottom: "12px" }}>{item.label.toUpperCase()}</div>
        ...
        <div className="cs-team-row" style={{ maxWidth: "1000px", margin: "32px auto 0", display: "flex", flexWrap: "wrap", gap: "10px" }}>
          {TEAM.map((t) => (
            <div key={t.role} className="cs-team-badge" style={{ padding: "10px 16px", borderRadius: "3px", border: `1px solid ${t.highlight ? GOLD : "rgba(255,255,255,0.1)"}`, background: t.highlight ? "rgba(255,215,0,0.06)" : "transparent", display: "flex", gap: "10px", alignItems: "center" }}>
              <span style={{ fontFamily: '"Press Start 2P",monospace', fontSize: "clamp(5px,1vw,6px)", color: t.highlight ? GOLD : "rgba(255,255,255,0.4)", letterSpacing: "1px" }}>{t.role.toUpperCase()}</span>
